...
Now we can write a list of individuals to keep along with an updated pedigree in some other files.   
...
plot(dtmp[upper.tri(dtmp,diag=T)], pch=20, col = add.alpha('black',0.6),cex=0.6,
       ylab='full pedigree pedigree - succint pedigree kinship',ylim =c(-0.5,0.5))
abline(h=0,lty=2)
abline(h=0.1,lty=2)
abline(h=0.2,lty=2)
...
Individuals that have been blacked out are sequenced ones... This captures almost all of our links while being small enough to be plot-able.  
